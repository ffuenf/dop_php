...
node.set['php']['conf_dir'] = '/etc/php/7.1/cli'
node.set['php']['ext_conf_dir'] = '/etc/php/7.1/conf.d'
...
node.set['php']['fpm']['service-name'] = 'php7.1-fpm'
node.set['php']['fpm']['dir'] = "#{node['php']['dir']}/7.1/fpm"
