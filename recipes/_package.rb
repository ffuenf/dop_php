...
apt_repo_uri = (node['php']['version'] == '5.6' || node['php']['version'] == '7.0' || node['php']['version'] == '7.1' || node['php']['version'] == '7.2' || node['php']['version'] == '7.3') && !node['php']['vendor_packages'] ? 'http://ppa.launchpad.net/ondrej/php/ubuntu' : 'http://ppa.launchpad.net/ondrej/php5/ubuntu'
